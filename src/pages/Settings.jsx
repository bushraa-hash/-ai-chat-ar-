...
export default function Settings() {
  ...
  const handleSave = (e) => {
    ...
    if(apiKey) {
        ...
        initGemini(apiKey); // re-init client
        setMessage('تم حفظ المفتاح بنجاح وتحديث الإعدادات.');
    } else {
        localStorage.removeItem('google_api_key');
        setMessage('تم حذف المفتاح المحلي. سيتم استخدام المفتاح الموجود في .env إن وجد.');
    }
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400 mb-4">
                        تم تصميم التطبيق للعمل مع مفتاح (API Key) من Google AI Studio (Gemini). يمكنك توفير المفتاح في ملف `.env`، أو إدخاله هنا للاستخدام المحلي في المتصفح فقط.
                    </p>
